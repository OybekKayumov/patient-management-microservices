...
public class LocalStack extends Stack {
	...
	private FargateService createFargateService(String id,
		...
		envVars.put("SPRING_KAFKA_BOOTSTRAP_SERVERS",
						"localhost.localstack.cloud:4510,	localhost.localstack" +
		...
		if (db != null) {
			envVars.put("SPRING_DATASOURCE_URL", "jdbc:posgresql://%s:%s/%s-db".formatted(
			...
			envVars.put("SPRING_DATASOURCE_HIKARI_INITIALIZATION_FAIL_TIMEOUT",
							"60000");
		}
